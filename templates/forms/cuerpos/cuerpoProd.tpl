...
{if isset($image) && isset($smarty.session.USER_ROL) && $smarty.session.USER_ROL<=ADMIN}
    <div class="mb-3">
        <label for="imagesToUpload" class="form-label">Subir una imagen ilustrativa del producto || Fromatos admitidos   .jpg   .jpeg    .png</label>
